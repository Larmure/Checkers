...
import fr.ubordeaux.pdp.serveur.ServerListService;

import java.util.List;

/**
 * Network command: {@code server list}
 * Listens for UDP broadcasts for 30 seconds and displays
 * active servers (last message received less than 30 seconds ago).
 */
