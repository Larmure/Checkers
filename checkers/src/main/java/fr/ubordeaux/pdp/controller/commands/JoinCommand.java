...
public class JoinCommand implements ClientCommand, Helpable {
    ...
    /**
     * @param session Session courante du client.
     * @param address Adresse fournie par l'utilisateur ({@code "host:port"},
     *                {@code "host"}, ou {@code null} pour les valeurs par défaut).
     */
