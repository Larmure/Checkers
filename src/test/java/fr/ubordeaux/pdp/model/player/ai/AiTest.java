...
class AiTest {
  ...
  void testBuildAi_minimax() {
    Ai ai = Ai.buildAi("minimax", 3, 1000);
  ...
  void testBuildAi_alphabeta() {
    Ai ai = Ai.buildAi("alphabeta", 3, 1000);
  ...
  void testBuildAi_invalidMode() {
    assertThrows(IllegalArgumentException.class, () -> Ai.buildAi("unknown", 3, 1000));
  }

  @Test
  void testBuildAi_iterative_returnsNull() {
    Ai ai = Ai.buildAi("iterative", 3, 1000);
