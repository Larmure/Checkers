 ...
 *
 * <p>This evaluator uses a basic material-based scoring system where:
 * <ul>
 ...
 * </ul>
 *
 * <p>The scoring is straightforward:
 * <ul>
 * <li>Pawn: 100 points
 * <li>Checker: 350 points
 * </ul>
 *
 * <p>This evaluator provides a baseline evaluation that focuses purely on material
...
public class SimpleEvaluator implements Evaluator {
   ...
   *
   * <p>The evaluation is calculated as:
   *
   * <pre>{@code
   ...
   * }</pre>
   *
   * <p>A positive score favors white, while a negative score favors black.
   *
