 ...
 *
 * <p>This class extends the base Player class and integrates AI algorithms to
 * automatically determine the best moves. It uses the Strategy pattern to allow
 * different AI algorithms and evaluation functions to be plugged in at runtime.
 *
 * <p>Key features:
 * <ul>
...
public class AiPlayer extends Player {
  ...
  /**
   * Creates a new AI player with default MinMax algorithm and SimpleEvaluator.
   *
   * @param name the name to identify the AI in the game
   */
   ...
   *
   * <p>This method delegates the move calculation to the configured AI algorithm,
